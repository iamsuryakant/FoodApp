      ...
      <section className="w-full my-6">
        <div className="w-full flex items-center justify-between">
          ...
          <div className = "hidden md:flex gap-3 items-center">
            ...
            <motion.div whileTap={{ scale: 0.75 }} className="w-8 h-8 rounded-lg bg-orange-300 hover:bg-orange-500  cursor-pointer hover:shadow-lg items-center justify-center"

              onClick={() => setScrollValue(-1000)}
            
            >

              <MdChevronLeft className = "text-white text-2xl mt-1 ml-1" />
            </motion.div>
            <motion.div whileTap={{ scale: 0.75 }} className="w-8 h-8 rounded-lg bg-orange-300 hover:bg-orange-500 cursor-pointer hover:shadow-lg items-center justify-center"
            ...
            >
              ...
              <MdChevronRight className="text-white text-2xl ml-1 mt-1" />
            </motion.div>
