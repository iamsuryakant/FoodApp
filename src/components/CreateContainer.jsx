    ...
    <div className='w-full min-h-screen flex items-center justify-center'>
      <div className="w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 gap-4 flex flex-col items-center justify-center">
        ...
        <div className="w-full">
          <select
            className='outine-none w-full text-base border-b-2 border-gray-200 p-2 rounded-md cursor-pointer'
            onChange={(e) => setCategory(e.target.value)}>
            <option value="other" className="bg-white">Select Category</option>
            {categories && categories.map(item => (
              <option key={item.id} className="text-textbase border-0 outline-none capitalize bg-white text-headingColor"
            ...
            {!imageAsset ? (
              <>
                ...
                <label className="w-full h-full flex flex-col items-center justify-center cursor-pointer">
                  ...
                  <input type="file" name="uploading" accept="image/*"
              ...
              <img src={imageAsset} alt="upload-img" className="w-full h-full object-cover" />
              <button
                type="button"
                className="absolute bottom-3 right-3 p-3 rounded-full bg-red-500 cursor-pointer outine-none hover:shadow-md duration-500 transition-all ease-in-out text-xl"
